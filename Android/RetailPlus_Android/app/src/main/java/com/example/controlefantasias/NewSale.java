...
public class NewSale extends ListActivity {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String produtoId = ((TextView) view.findViewById(R.id.fantasiaId)).getText()
						.toString();
				String nomeAux = ((TextView) view.findViewById(R.id.nome)).getText()
						.toString();
				String preco = ((TextView) view.findViewById(R.id.preco)).getText()
						.toString();

				// Starting new intent
				Intent in = new Intent(getApplicationContext(),	NewSale1.class);
				// sending data to next activity
				in.putExtra(TAG_ID, produtoId);
				in.putExtra(TAG_NOME, nomeAux);
				in.putExtra("preco", preco);
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(NewSale.this);
